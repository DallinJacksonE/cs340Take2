      ...
      <div className="form-main w-100 m-auto rounded">
        <form>
          ...
          <div className="text-center mb-3">
            <OAuth name={"Google"} id={"googleTooltip"} icon={["fab", "google"]} />
            <OAuth name={"Facebook"} id={"facebookTooltip"} icon={["fab", "facebook"]} />
            <OAuth name={"Twitter"} id={"twitterTooltip"} icon={["fab", "twitter"]} />
            <OAuth name={"LinkedIn"} id={"linkedInTooltip"} icon={["fab", "linkedin"]} />
            <OAuth name={"Github"} id={"githubTooltip"} icon={["fab", "github"]} />
          </div>
